...
-- Copiando dados para a tabela pwii.adm: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela pwii.clientes: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela pwii.produto: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `produto` DISABLE KEYS */;
INSERT INTO `produto` (`Id_Produto`, `Qt_Prod`, `Tamanho_Prod`, `Nome_Prod`, `Valor`, `Descrição`, `Tipo`) VALUES
